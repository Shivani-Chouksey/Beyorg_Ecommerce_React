...
import logo from '../img/beyorg  logo.png';
            ...
            <div className="container d-flex flex-wrap flex-xl-nowrap align-items-center justify-content-between">
                <a className="brand header_logo d-flex align-items-center" href="index.html">
                    <span className="logo">
                        ...
                        {/* <svg width="48" height="45" viewBox="0 0 48 45" fill="none" xmlns="http://www.w3.org/2000/svg">     </svg> */}
                            ...
                            <defs>
                                <ClipPath id="logoHeader">
                                    <React width="48" height="45" fill="white" />
                                </ClipPath>
                            </defs> */}
                    ...
                    <ul className="header_nav-list">
                            ...
                            {/* <!-- <div className="dropdown-menu collapse" id="homeMenu">
                                <ul className="dropdown-list">
                                    <li className="list-item nav-item" data-page="home">
                                        <a className="dropdown-item" href="index.html">Home 01</a>
                                    </li>
                                    <li className="list-item nav-item" data-page="home2">
                                        <a className="dropdown-item" href="index2.html">Home 02</a>
                                    </li>
                                </ul>
                            </div> --> */}
                        </li>
                        <li className="header_nav-list_item dropdown">
                            ...
                            <div className="dropdown-menu collapse" id="shopMenu">
                                <ul className="dropdown-list">
                                    <li className="list-item nav-item" data-page="shop">
                                        <NavLink className="dropdown-item" to="/profile">All Products</NavLink>
                                    </li>
                                    {/* <!-- <li className="list-item nav-item" data-page="shop2">
                                        <a className="dropdown-item" href="shop2.html">Shop 02</a>
                                    </li> --> */}
                                    <li className="list-item nav-item" data-page="product">
                                        <NavLink className="dropdown-item" to="/product-details">Single Product </NavLink>
                                    </li>
                                    {/* <!-- <li className="list-item nav-item" data-page="product2">
                                        <a className="dropdown-item" href="product2.html">Single Product 02</a>
                                    </li> -->
                                    <!-- <li className="list-item nav-item" data-page="compare">
                                        <a className="dropdown-item" href="compare.html">Compare List</a>
                                    </li> --> */}
                                </ul>
                            </div>
                        </li>
                        <li className="header_nav-list_item dropdown">
                            ...
                            {/* <!-- <div className="dropdown-menu collapse" id="newsMenu">
                                <ul className="dropdown-list">
                                    <li className="list-item nav-item" data-page="news">
                                        <a className="dropdown-item" href="news.html">News 01</a>
                                    </li>
                                    <li className="list-item nav-item" data-page="news2">
                                        <a className="dropdown-item" href="news2.html">News 02</a>
                                    </li>
                                    <li className="list-item nav-item" data-page="post">
                                        <a className="dropdown-item" href="post.html">Single Post 01</a>
                                    </li>
                                    <li className="list-item nav-item" data-page="post2">
                                        <a className="dropdown-item" href="post2.html">Single Post 02</a>
                                    </li>
                                </ul>
                            </div> --> */}
                        </li>
                        <li className="header_nav-list_item dropdown">
                            ...
                            {/* <!-- <div className="dropdown-menu collapse" id="pagesMenu">
                                <ul className="dropdown-list">
                                    <li className="list-item nav-item" data-page="about">
                                        <a className="dropdown-item" href="about.html">About</a>
                                    </li>
                                    <li className="list-item nav-item" data-page="team">
                                        <a className="dropdown-item" href="team.html">Team</a>
                                    </li>
                                    <li className="list-item nav-item" data-page="faq">
                                        <a className="dropdown-item" href="faq.html">FAQ</a>
                                    </li>
                                    <li className="list-item nav-item" data-page="contacts">
                                        <a className="dropdown-item" href="contacts.html">Contacts 01</a>
                                    </li>
                                    <li className="list-item nav-item" data-page="contacts2">
                                        <a className="dropdown-item" href="contacts2.html">Contacts 02</a>
                                    </li>
                                    <li className="list-item nav-item" data-page="404">
                                        <a className="dropdown-item" href="404.html">Error Page</a>
                                    </li>
                                </ul>
                            </div> --> */}
                        </li>
                ...
                <div className="header_user d-flex justify-content-end align-items-center">
                    ...
                    <NavLink className="header_user-action d-inline-flex align-items-center justify-content-center" to="/wishlist">
                        <i className="icon-heart"></i>
                    </NavLink>
                    <NavLink className="header_user-action d-inline-flex align-items-center justify-content-center" to="/cart">
                    ...
                    {/* <NavLink
                        ...
                        aria-controls="cartOffcanvas" to="/cart"
                    >
                        <i className="icon-basket"></i>
                    </NavLink> */}
